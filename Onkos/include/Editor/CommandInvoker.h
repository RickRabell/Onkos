...
public:
   ...
   */
  void 
  executeCommand(EU::TSharedPointer<Command> command);
   ...
   */
  bool 
  canUndo() const { return !m_undoStack.empty(); }
   ...
   */
  bool 
  canRedo() const { return !m_redoStack.empty(); }
   ...
   */
  size_t 
  getMaxHistorySize() const { return m_maxHistorySize; }
   ...
   */
  void 
  setMaxHistorySize(size_t maxSize) { m_maxHistorySize = maxSize; }
   ...
   */
  size_t 
  getUndoStackSize() const { return m_undoStack.size(); }
   ...
   */
  size_t 
  getRedoStackSize() const { return m_redoStack.size(); }
